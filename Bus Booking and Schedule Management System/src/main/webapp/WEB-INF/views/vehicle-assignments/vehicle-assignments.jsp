...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-800 flex items-center gap-2">
            <i class="fa-solid fa-bus text-purple-600"></i> Bus Assignments
        </h1>
        <div class="flex gap-2">
            ...
            <button id="openModalBtn"
                    class="px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg shadow-sm transition-colors flex items-center gap-2">
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
        <div class="flex flex-col md:flex-row gap-4">
            <div class="flex-grow">
                ...
                <div class="relative">
                    <input type="text" id="searchInput" placeholder="Search by customer or bus..."
                           class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-300 focus:border-purple-500 outline-none transition">
                    <i class="fa-solid fa-search absolute left-3 top-3 text-gray-400"></i>
                </div>
            </div>
            <div class="w-full md:w-1/4">
                <label for="filterSelect" class="block text-sm font-medium text-gray-700 mb-1">Filter by</label>
                <select id="filterSelect" class="w-full py-2 px-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-300 focus:border-purple-500 outline-none transition">
    ...
    <div id="loading" class="hidden text-center my-8">
        <div class="inline-block relative w-20 h-20">
            ...
            <i class="fa-solid fa-bus text-purple-600 text-xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></i>
        </div>
        <p class="mt-4 text-gray-600">Loading bus assignments...</p>
    </div>

    <!-- Empty State -->
    <div id="emptyState" class="hidden bg-white rounded-lg shadow-sm p-8 text-center">
        <div class="mx-auto w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-4">
            <i class="fa-solid fa-bus text-gray-400 text-2xl"></i>
        </div>
        <h3 class="text-xl font-medium text-gray-700 mb-2">No Assignments Found</h3>
        <p class="text-gray-500 mb-6">Get started by creating your first bus assignment.</p>
        <button id="emptyStateBtn" class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg shadow-sm transition-colors flex items-center gap-2 mx-auto">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse" id="assignmentsTable">
                ...
                <tr>
                    ...
                    <th class="p-3 font-medium">Bus</th>
...
<div id="assignmentModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div class="bg-white p-6 rounded-xl shadow-xl w-full max-w-md relative">
        ...
        <h2 id="modalTitle" class="text-xl font-semibold mb-5 text-gray-800 flex items-center gap-2">
            <i class="fa-solid fa-clipboard-list text-teal-600"></i> New Bus Assignment
        </h2>
        ...
        <form id="assignmentForm" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    <select id="bookingId" class="w-full border border-gray-300 p-2 rounded-lg focus:ring-2 focus:ring-purple-300 focus:border-purple-500 outline-none transition">
            ...
            <!-- Bus -->
            <div>
                <label for="vehicleId" class="block mb-1 font-medium text-gray-700">Bus</label>
                <div class="relative">
                    <select id="vehicleId" class="w-full border border-gray-300 p-2 rounded-lg focus:ring-2 focus:ring-purple-300 focus:border-purple-500 outline-none transition">
                ...
                <p id="vehicleError" class="text-red-600 text-sm hidden mt-1">
                    <i class="fa-solid fa-circle-exclamation"></i> Please select a valid bus
                </p>
            ...
            <div class="flex justify-end gap-2 pt-4">
                ...
                <button type="submit" id="saveBtn"
                        class="px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white rounded-lg shadow-sm transition-colors flex items-center gap-2">
...
<div id="confirmationModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div class="bg-white p-6 rounded-xl shadow-xl w-full max-w-sm relative">
        ...
        <p class="text-gray-600 mb-5">Are you sure you want to delete this bus assignment? This action cannot be undone.</p>
