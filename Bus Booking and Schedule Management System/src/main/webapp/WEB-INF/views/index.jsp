...
<head>
    ...
    <title>Ceylon Buses - Bus Booking System Sri Lanka</title>
...
<section class="hero-bg min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10 text-center text-white">
        <div class="fade-in">
            <h1 class="text-5xl md:text-7xl font-bold mb-6 leading-tight">
                Discover <span class="gradient-text">Ceylon Busses</span>
            </h1>
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-90">
                Book bus tickets easily to top destinations across Sri Lanka
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center bounce-in">
                <button class="bg-gradient-to-r from-orange-500 to-emerald-600 hover:from-orange-600 hover:to-emerald-700 text-white px-8 py-4 rounded-full text-lg font-semibold transform hover:scale-105 transition-all duration-300 shadow-2xl">
                    <i class="fas fa-binoculars mr-2"></i>
                    Book a Bus
                </button>
                <button class="bg-transparent border-2 border-white hover:bg-white hover:text-black-600 text-white px-8 py-4 rounded-full text-lg font-semibold transform hover:scale-105 transition-all duration-300">
    ...
    <div class="absolute top-20 left-10 float">
        <i class="fas fa-leaf text-orange-300 text-3xl opacity-20"></i>
    </div>
    ...
    <div class="container mx-auto px-6">
        <div class="text-center mb-16 slide-up">
            <h2 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
                Popular <span class="gradient-text">Bus Routes</span>
            </h2>
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                Choose your route and book your bus tickets easily
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="card-hover bg-white rounded-2xl overflow-hidden shadow-xl border pulse-border">
                ...
                <div class="p-6">
                    <h3 class="text-2xl font-bold text-gray-800 mb-2">Colombo to Kandy</h3>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="/create-booking?name=Colombo to Kandy&price=650"
            ...
            <div class="card-hover bg-white rounded-2xl overflow-hidden shadow-xl border pulse-border">
                ...
                <div class="p-6">
                    <h3 class="text-2xl font-bold text-gray-800 mb-2">Colombo to Nuwara Eliya</h3>
                    <p class="text-gray-600 mb-4">Enjoy the hill country scenery with a comfortable bus ride.</p>
                    <div class="flex items-center justify-between">
                        <div class="text-2xl font-bold text-green-600">
                            LKR 1200
                            <span class="text-sm font-normal text-gray-500">/person</span>
                        </div>
                        <a href="/create-booking?name=Colombo to Nuwara Eliya&price=1200"
                           class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg transition-colors inline-block text-center no-underline">
                            Book Now
                        </a>
                    </div>
            ...
            <div class="card-hover bg-white rounded-2xl overflow-hidden shadow-xl border pulse-border">
                ...
                <div class="p-6">
                    <h3 class="text-2xl font-bold text-gray-800 mb-2">Colombo to Galle</h3>
                    <p class="text-gray-600 mb-4">Comfortable bus ride along Sri Lanka's beautiful southern coast.</p>
                    <div class="flex items-center justify-between">
                        <div class="text-2xl font-bold text-green-600">
                            LKR 750
                            <span class="text-sm font-normal text-gray-500">/person</span>
                        </div>
                        <a href="/create-booking?name=Colombo to Galle&price=750"
                           class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg transition-colors inline-block text-center no-underline">
                            Book Now
                        </a>
                    </div>
...
<section class="py-20 bg-gray-50">
    <div class="container mx-auto px-6">
        <div class="text-center mb-16 slide-up">
            <h2 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
                Why Choose <span class="gradient-text">Ceylon Buses</span>
            </h2>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="text-center bounce-in">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Modern Buses</h3>
                <p class="text-gray-600">Comfortable and air-conditioned buses for safe travel.</p>
            </div>
            ...
            <div class="text-center bounce-in" style="animation-delay: 0.2s;">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Many Routes</h3>
                <p class="text-gray-600">Daily services covering all major cities and tourist spots.</p>
            </div>
            ...
            <div class="text-center bounce-in" style="animation-delay: 0.4s;">
                ...
                <p class="text-gray-600">Book your seats online quickly and easily.</p>
            </div>
            ...
            <div class="text-center bounce-in" style="animation-delay: 0.6s;">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-2">Safe Travels</h3>
                <p class="text-gray-600">Our buses are insured and follow all safety regulations.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-6 text-center">
        <div class="fade-in">
            ...
            <p class="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
                Travel across Sri Lanka conveniently and safely with our bus services.
            </p>
...
<footer class="bg-gray-800 text-white py-12">
    <div class="container mx-auto px-6">
        <div class="grid md:grid-cols-4 gap-8">
            <div>
                <h3 class="text-2xl font-bold gradient-text mb-4"Ceylon Buses>  </h3>
                <p class="text-gray-300 mb-4">Sri Lanka's reliable bus booking service for tourists and locals.</p>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-300">
                    <li><a href="#" class="hover:text-green-400 transition-colors">Bus Routes</a></li>
                    <li><a href="#" class="hover:text-green-400 transition-colors">Book a Bus</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-300">
                    <li><a href="#" class="hover:text-green-400 transition-colors">Colombo</a></li>
                    <li><a href="#" class="hover:text-green-400 transition-colors">Kandy</a></li>
                    <li><a href="#" class="hover:text-green-400 transition-colors">Galle</a></li>
                    <li><a href="#" class="hover:text-green-400 transition-colors">Nuwara Eliya</a></li>
                </ul>
            </div>
            <div>
                ...
                <div class="space-y-2 text-gray-300">
                    ...
                    <p><i class="fas fa-envelope mr-2 text-green-400"></i>info@ceylonbus.lk</p>
                </div>
            </div>
        </div>
        <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 Wild Ceylon Buses. All rights reserved. | Travel Sri Lanka by Bus</p>
        </div>
    </div>
</footer>
