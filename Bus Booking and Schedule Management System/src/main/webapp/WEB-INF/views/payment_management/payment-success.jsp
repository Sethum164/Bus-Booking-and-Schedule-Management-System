        ...
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="mb-12 slide-in">
                ...
                <p class="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                    🎉 Congratulations! Your bus booking has been confirmed.
                    Get ready for an unforgettable journey through Sri Lanka's bus management!
                </p>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gradient-to-r from-green-100 to-emerald-100 p-6 rounded-xl">
                        ...
                        <ul class="text-green-700 space-y-2 text-left">
                            ...
                            <li class="flex items-start">
                                <i class="fas fa-check-circle text-green-600 mr-2 mt-1"></i>
                                <span>Prepare for an amazing ceylon bus experience!</span>
                            </li>
                        </ul>
                    </div>
                </div>
