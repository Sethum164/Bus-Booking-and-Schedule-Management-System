...
<head>
    ...
    <title>Complete Payment - Ceylon Bus</title>
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="text-center mb-12 fade-in">
            ...
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                Secure payment processing for your ceylon bus
            </p>
        </div>
                    ...
                    <div id="bankTransferInfo" class="hidden">
                        <div class="bg-blue-50 p-6 rounded-xl">
                            ...
                            <div class="space-y-2 text-blue-700">
                                ...
                                <p><strong>Account Name:</strong> Ceylon Bus</p>
                                <p><strong>Account Number:</strong> 1234-5678-9011</p>
                    ...
                    <div id="cashPaymentInfo" class="hidden">
                        <div class="bg-green-50 p-6 rounded-xl">
                            ...
                            <div class="space-y-2 text-green-700">
                                ...
                                <p><strong>Office Address:</strong>Ceylon Bus Adventures, Colombo 03</p>
                            ...
                            <div class="payment-card relative h-full" id="virtualCard">
                                ...
                                <div class="card-front">
                                    <div class="flex justify-between items-start mb-8">
                                        <div class="text-2xl font-bold">CEYLON BUS</div>
                                ...
                                <div class="card-back">
                                    ...
                                    <div class="mt-8 text-sm text-gray-300">
                                        This card is issued by Ceylon Bus for demonstration purposes only.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-xl">
                        ...
                        <div class="space-y-3 text-gray-600">
                            <div class="flex items-center">
                                ...
                                <span>267-bit SSL Encryption</span>
                            </div>
                            <div class="flex items-center">
                                <i class="fas fa-check-circle text-green-500 mr-3"></i>
                                <span>PKI DER Compliant</span>
                            </div>
                            <div class="flex items-center">
                                <i class="fas fa-check-circle text-green-500 mr-3"></i>
