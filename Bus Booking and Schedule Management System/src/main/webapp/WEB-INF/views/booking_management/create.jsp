...
<head>
    ...
    <title>Book Your Bus Ride - Bus Booking System</title>
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="text-center mb-12 fade-in">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
                Book Your <span class="bg-gradient-to-r from-green-500 to-emerald-600 bg-clip-text text-transparent">Ceylon Bus</span>
            </h1>
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                Complete your booking details and reserve your seat easily
                ...
                <div class="bg-gradient-to-r from-green-500 to-emerald-600 p-8 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-green-100 text-lg">Selected Bus Route</p>
                        </div>
                    ...
                    <form id="bookingForm" class="space-y-6">
                        ...
                        <div class="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border-2 border-green-200">
                            ...
                            <p class="text-green-600 mt-2">
                                ...
                                Final amount will be calculated based on selected date and seats
                            </p>
                        </div>
