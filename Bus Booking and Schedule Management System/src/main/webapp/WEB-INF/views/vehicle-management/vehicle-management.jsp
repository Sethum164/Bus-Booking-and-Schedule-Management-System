...
<head>
    ...
    <title>Bus Booking - Ceylon Bus</title>
    ...
    <div class="container mx-auto px-6">
        <div class="text-center text-white fade-in">
            <h1 class="text-4xl md:text-5xl font-bold mb-4">
                Bus <span class="gradient-text">Booking</span>
            </h1>
            <p class="text-xl text-green-100 max-w-2xl mx-auto">
                Manage your ceylon bus fleet efficiently
            </p>
        </div>
    </div>
</section>
...
<div class="container mx-auto px-6 py-8">
    ...
    <div id="emptyState" class="hidden">
        <div class="bg-white rounded-lg shadow-sm border p-12 text-center">
            ...
            <h3 class="text-xl font-semibold text-gray-600 mb-2">No buses found</h3>
            <p class="text-gray-500 mb-6">Get started by adding your first bus to the fleet</p>
            <button
    ...
    <div class="bg-white rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
        <div class="p-6">
            <div class="flex justify-between items-center mb-6">
                <h2 id="modalTitle" class="text-xl font-semibold text-gray-900">Add Bus</h2>
            ...
            <form id="vehicleForm" class="space-y-4">
                ...
                <div>
                    ...
                    />
                    <span id="vehicleNumberError" class="text-red-500 text-xs hidden">Valid bus number required</span>
                </div>
                ...
                <div>
                    ...
                    <span id="typeError" class="text-red-500 text-xs hidden">Bus type is required</span>
                </div>
                ...
                <div class="flex gap-3 pt-4">
                    ...
                    >
                        <span id="submitText">Add Bus</span>
    ...
    <div class="bg-white rounded-lg max-w-sm w-full">
        <div class="p-6">
            <div class="flex items-center mb-4">
                ...
                <h3 class="text-lg font-semibold text-gray-900">Delete Bus</h3>
            </div>
