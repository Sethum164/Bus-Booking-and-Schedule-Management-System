...
public class BusAssignmentController {
    ...
    @Autowired
    private BusAssignmentService vehicleAssignmentService;

    @PostMapping
    public ResponseEntity<?> createVehicleAssignment(@RequestBody BusAssignmentDTOS.CreateVehicleAssignmentRequest request) {
        try {
            BusAssignmentDTOS.VehicleAssignmentResponse response = vehicleAssignmentService.createVehicleAssignment(request);
    ...
    public ResponseEntity<?> getVehicleAssignmentById(@PathVariable Long id) {
        try {
            Optional<BusAssignmentDTOS.VehicleAssignmentResponse> assignment = vehicleAssignmentService.getVehicleAssignmentById(id);
    ...
    public ResponseEntity<?> getAllVehicleAssignments() {
        try {
            List<BusAssignmentDTOS.VehicleAssignmentResponse> assignments = vehicleAssignmentService.getAllVehicleAssignments();
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateVehicleAssignment(@PathVariable Long id, @RequestBody BusAssignmentDTOS.UpdateVehicleAssignmentRequest request) {
        try {
            Optional<BusAssignmentDTOS.VehicleAssignmentResponse> updatedAssignment = vehicleAssignmentService.updateVehicleAssignment(id, request);
